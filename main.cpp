...
void check()
{
    if(m_word=="hi"||m_word=="hey"||m_word=="hello"||m_word=="hlo")
         {
            x.typing("Hi RAJ, how can I help you..");
         }
    ...
    else if (m_word=="play")
    {
      ...
      {
          x.speak("Sorry RAJ ,you does not enter song name");
       //   tutorial("play");
      }
      else
        {
          ...
          {
            x.speak("Good bye, RAJ");
            Sleep(600);
            cout<<"\n\n\n\n\n\n\t\t\t\t\t";
            x.typing("Created By : RAJ");
            Sleep(1500);
            exit(1);
          }
      ...
      else if(m_word=="what"||m_word=="who"||m_word=="how"||m_word=="when"||m_word=="where"||m_word=="why")
      {
          ...
          else if (input=="who are you"||input=="who created you"||input=="who made you")
          {
              ...
              Sleep(300);
              line();
              x.typing("RAJ has made me.");
              Sleep(300);
              line();
              x.typing("I was created on 23 MARCH ,2025");
              Sleep(300);
              line();
       ...
       {
         x.speak("Sorry RAJ, unknown command...");
         cnt++;
         if(cnt>=3)
         {  Sleep(600);
            x.speak("I think ");
...
Sleep(1000);
system("color c");
cout << setfill(' ') << setw(50) <<" RAJ Hacking Lab  \n";
Sleep(1000);
line();
...
{
cnt=0;
x.speak("you can use only these commands");
system("cls");
cout<<"\n\n";
system("color f");
line();
